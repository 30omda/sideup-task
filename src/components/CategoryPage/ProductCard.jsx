...
export const ProductCard = ({
    ...
    return (
        <div className="p-4 border rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow flex flex-col h-full">
            <img
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="mt-auto space-y-2">
                    ...
                    <button
                        ...
                        className={`w-full px-4 py-2 rounded-lg font-medium transition-colors ${product.isOutOfStock
